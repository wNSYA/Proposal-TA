...
\begin{center}
    ...
    {\Large\bfseries PENGEMBANGAN SISTEM KONTROL AKSES BERBASIS PENGENALAN WAJAH UNTUK KONDISI DARURAT PADA BANGUNAN CERDAS}\\
     \vspace{4cm}
...
% ==========================================
	Pembimbing  \\[3cm]
	Dr. Fadhil Hidayat, S.Kom., M.T.  \\[0.2cm]
...
\input{Lampiran-C.tex}
\input{Lampiran-D.tex}
\input{Lampiran-E.tex}
